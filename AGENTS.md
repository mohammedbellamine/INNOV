...
The app is called **AI Readiness** by default. To rename it, **do not hand-edit
...
- The wordmark is `AI Readiness*` — keep it in one place per page so renames are cheap.
